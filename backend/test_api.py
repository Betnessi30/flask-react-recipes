...
class APITestCase(unittest.TestCase):
    ...
    def test_create_a_new_recipe(self):
        signup_response=self.client.post('/auth/signup',
            json={"username":"testuser",
                  "email":"testuser@test.com",
                  "password":"password"}
        ...
        create_a_recipe_response=self.client.post(
            '/recipe/recipes',
        ...
        status_code=create_a_recipe_response.status_code
      
       # print(create_a_recipe_response.json)
        self.assertEqual(status_code,201)
